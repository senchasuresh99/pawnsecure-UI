...
export default function CustomerRegister() {
  ...
  const [goToNextAfterSuccess, setGoToNextAfterSuccess] = useState(false);
  ...
  function getNextPathAfterCustomerSave() {
    return isPartialityDashboard ? "/dealer/customer-search" : "/dealer/details";
  }

  function getNextNavigationState() {
    return isPartialityDashboard ? { mode: "RENEWAL_EXTEND" } : undefined;
  }

  function navigateToNextStep() {
    const nextPath = getNextPathAfterCustomerSave();
    const nextState = getNextNavigationState();
  ...
  function closePopup() {
    const shouldGoNext = popup?.type === "success" && goToNextAfterSuccess;

    setPopup(null);

    if (shouldGoNext) {
      setGoToNextAfterSuccess(false);
    ...
    return (
      <div className="mt-6 border border-purple-200 bg-purple-50 rounded-3xl p-4 sm:p-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-5">
          ...
          >
            {isPartialityDashboard ? "Confirm & Review" : "Confirm & Continue"}
          </button>
          ...
          <div className="p-5 xl:p-6 max-w-[1400px] w-full mx-auto flex-1">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80 mt-1">
                    {isPartialityDashboard
                      ? "Register customer and continue to customer review"
            ...
            <div className="grid grid-cols-12 gap-6">
              <div className="col-span-12 xl:col-span-8 bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                ...
                <CustomerStepIndicator partiality={isPartialityDashboard} />
...
function CustomerStepIndicator({ partiality = false }: { partiality?: boolean }) {
  if (partiality) {
    return (
