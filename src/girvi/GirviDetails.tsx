          ...
          <div className="xl:flex xl:items-end xl:justify-between">
            <div>
              ...
              <p className="text-sm xl:text-base opacity-80 mt-2 max-w-2xl">
                Enter pledge item details, calculate value, upload item photo,
                and save girvi record securely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-5 xl:p-8 space-y-7">
                ...
                <label className="flex flex-col md:flex-row items-center justify-center gap-4 border-dashed border-2 border-purple-200 rounded-2xl p-5 cursor-pointer bg-purple-50/40 hover:bg-purple-50 transition">
                  {photoPreview ? (
                    <img
                      src={photoPreview}
                      alt="Item preview"
                      className="w-28 h-28 rounded-2xl object-cover border bg-white"
                    />
                  ) : (
              ...
              <Section title="Remarks">
                <textarea
                  ...
                  className="w-full border rounded-2xl p-4 bg-gray-50 text-sm outline-none focus:ring-2 focus:ring-purple-500"
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                ...
                {photoPreview ? (
                  <img
                    src={photoPreview}
                    alt="Item preview"
                    className="w-full h-64 rounded-2xl object-cover border bg-gray-50"
                  />
                ) : (
                  <div className="h-64 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 flex flex-col items-center justify-center text-gray-400">
